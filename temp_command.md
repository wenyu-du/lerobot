...
lerobot-record  --robot.type=so101_follower     --robot.port='/dev/follower_port'     --robot.cameras="{ camera1: {type: opencv, index_or_path: 2, width: 640, height: 480, fps: 30}, camera2: {type: opencv,index_or_path: 6, width: 640, height: 480, fps: 30}}"     --robot.id=my_awesome_follower_arm     --teleop.type=so101_leader     --teleop.port='/dev/leader_port'     --teleop.id=my_awesome_leader_arm           --dataset.single_task="Pick and place the brown rabbit toy"     --display_data=true --dataset.repo_id=wenyudu/demo_pi05_20251225_b3     --dataset.num_episodes=20
```
...
```bash
lerobot-train \
    --dataset.repo_id=wenyudu/demo_pi05_20251225_merged   \
    --policy.type=pi05 \
    --output_dir=./outputs/pi05_training_1225_merged \
...
lerobot-edit-dataset \
    --repo_id wenyudu/demo_pi05_20251225_merged \
    --operation.type merge \
    --operation.repo_ids "['wenyudu/demo_pi05_20251225_b1' , 'wenyudu/demo_pi05_20251225_o1' ,   'wenyudu/demo_pi05_20251225_o3' ,'wenyudu/demo_pi05_20251225_b2', 'wenyudu/demo_pi05_20251225_o1_2', 'wenyudu/demo_pi05_20251225_b3' , 'wenyudu/demo_pi05_20251225_o2']"
...
# 加载数据集并验证  
dataset = LeRobotDataset("your/dataset_id")  
